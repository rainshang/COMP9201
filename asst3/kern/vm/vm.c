...
static int alloc_frame(struct page_table_entry *pte, struct addrspace *as, vaddr_t faultvaddr)
{
...
static int insert_pht(struct addrspace *as, vaddr_t faultvaddr, uint32_t index)
{
