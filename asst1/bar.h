...
struct barorder
{
        ...
        struct semaphore *order_done; // will lock this order until serve_order() executed
        char is_semaphore_init;       // indicate order_done is initialised by us, not the system
};
